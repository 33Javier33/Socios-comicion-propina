// Prefijo de la caché de Horarios (index2.html), que vive en el MISMO dominio
// que la app de administración: sin este prefijo se leería la versión de la
// otra app y mostraría un número que no corresponde.
const VERSION_PREFIJO = 'horarios-mesas-v';
const VERSION_FALLBACK = 13;
