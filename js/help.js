...
const BASE_CONOCIMIENTO = [
    ...
    { id:'don1', cat:'anticipos', titulo:'¿Cómo funciona la sección Donaciones?', tags:['donacion','donaciones','colecta','aporte','ayuda','solidario','descuento'],
      ...
      nota:'💡 Lo recaudado NO se abona al balance del socio ayudado: la administración le entrega el dinero aparte, la app solo lleva la cuenta. Si te equivocas, el botón 🗑 de cada aporte lo anula y le devuelve el monto al socio.' },
